...
class ExamsController extends Zend_Controller_Action {
	...
	public function searchAction() {
		...
		$this->view->exams = $exams->fetch ( $this->getRequest ()->course, $this->getRequest ()->lecturer, $this->getRequest ()->semester, $this->getRequest ()->examType, $this->getRequest ()->degree, "3" )		// 3 means public state
		;
	}
